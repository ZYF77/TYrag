...
## 1. 核验结论（截至 2026-08-05）

- RAGFlow 官方仓库最新稳定 release 为 `v0.26.4`，发布于 2026-07-07，tag commit 为 `cb93883f3f8c975eecb2fed81210effeb3bdb06f`。
- 官方 README 要求源代码 tag 与 Docker image 版本匹配。
