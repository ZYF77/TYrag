...
[Insert text here]`,
    ...
    datasetOverview: {
      downloadTip: 'Files waiting to be parsed (not started yet).',
      processingTip: 'Files currently being processed by the ingestion pipeline.',
      totalFiles: 'Total files',
      downloading: 'Pending parse',
      downloadSuccessTip: 'Total ingested files',
      downloadFailedTip: 'Total ingest failures',
