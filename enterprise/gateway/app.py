...
ERROR_CODES = {
    ...
    "RAGFLOW_TOOL_PROTOCOL_INVALID": (502, False),
    "REASONING_MODE_NOT_ALLOWED": (403, False),
...
SAFE_ERROR_MESSAGES = {
    ...
    "REASONING_MODE_NOT_ALLOWED": "当前认证方式不能使用该推理档位。",
    ...
    "RAGFLOW_TOOL_PROTOCOL_INVALID": "问答服务返回了无法识别的工具结果，请稍后重试。",
